...
![](https://nakulpadalkar.com/wp-content/uploads/2023/07/na_c-600x1024.jpg){width="90%"}
...
digraph Modules { style=filled bgcolor="#FAFAFA" fontname="Montserrat" fontsize=10.0 rankdir=TD color="#FAFAFA";
newrank=true;compound=true;

    
    graph [bgcolor="white", splines=ortho, fontname="Montserrat"];


    node [nojustify=false, shape=plaintext, fontsize=8, width=0.5, height=0.5,fontname="Montserrat"];

    // Lab 01 Card
    Lab01 [label=< 
        <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0">
            <TR>
                <TD BGCOLOR="limegreen" ALIGN="CENTER" COLSPAN="2">
                    <FONT COLOR="black" COLSPAN="1"><B>LAB 01</B></FONT>
                </TD>
            </TR>
            <TR>
                <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
                    <FONT COLOR="black" COLSPAN="1"><B>Introduction to GitHub</B></FONT>
                </TD>
            </TR>
            <TR>
                <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
                    <FONT COLOR="black" COLSPAN="1"><B>Due&nbsp;</B>&nbsp;:&nbsp; Week 1 Day 6</FONT>
                </TD>
            </TR>
                              <TR>
                <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
                    <FONT COLOR="black" COLSPAN="1">Submit Github link on Blackboard</FONT>
                </TD>
                            </TR>
        </TABLE>
    >];
    ...
    // Lab 02 Card
    // Lab02 [style = invis , label=< 
    //     <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0">
    //         <TR>
    //             <TD BGCOLOR="limegreen" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>LAB 02</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Quarto GitHub Pages</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Due&nbsp;</B>&nbsp;:&nbsp; Week 2 Day 6</FONT>
    //             </TD>
    //         </TR>
    //                           <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    ...
    //         <TR>
    //             <TD BGCOLOR="plum1" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Portfolio Website</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Follows directly from Lab 02</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    ...
    // Layout
    // Lab01 -> Lab02 [color=invis]; // Align the cards
    // Lab01 -> PortfolioCard [style=dashed, weight=1, arrowsize=.5, weight=2.,color="#339966"]; // Align the cards


// subgraph clusterB{

//     node [nojustify=false, shape=plaintext, fontsize=10, width=2.0, height=1.5,fontname="Montserrat"];

//     // Lab 01 Card
//     AWS01 [label=< 
//         <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0">
//             <TR>
//                 <TD BGCOLOR="orange" ALIGN="CENTER" COLSPAN="2">
//                     <FONT COLOR="black" COLSPAN="1"><B>AWS Cloud Lab</B></FONT>
//                 </TD>
//             </TR>
//             <TR>
//                 <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
//                     <FONT COLOR="black" COLSPAN="1"><B>Module 01</B></FONT>
//                 </TD>
//             </TR>
//             <TR>
//                 <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
//                     <FONT COLOR="black" COLSPAN="1">Complete Module 01 on AWS Academy</FONT>
//                 </TD>
//             </TR>
//         </TABLE>
//     >];
    ...
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Module 02</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1">Complete Module 02 on AWS Academy</FONT>
    //             </TD>
    //         </TR>
    //     </TABLE>
    // >];

    // AssignmentCard [label=< 
    //     <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="2">
    //         <TR>
    //             <TD BGCOLOR="skyblue" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Assignment 01</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Follows directly AWS Cloud Labs</B></FONT>
    //             </TD>
    //         </TR>
    //         <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    //                 <FONT COLOR="black" COLSPAN="1"><B>Due&nbsp;</B>&nbsp;:&nbsp; Week 3 Day 6</FONT>
    //             </TD>
    //         </TR>
    //               <TR>
    //             <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
    ...
    // Layout
    // AWS01 -> AWS02 [weight=1,arrowsize=.5, weight=2.,color="orange"]; // Align the cards
    // AWS01 -> AssignmentCard [style=dashed, weight=1,arrowsize=.5, weight=2.,color="orange"]; // Align the cards
    // AWS01 -> AssignmentCard [weight=1,arrowsize=.5, weight=2.,color="#339966"]; // Align the cards
...
//     ProjectCard [style="dashed", label=< 
//         <TABLE BORDER="0" CELLBORDER="0" CELLSPACING="0" CELLPADDING="2">
//             <TR>
//                 <TD BGCOLOR="#336699" ALIGN="CENTER" COLSPAN="2">
//                     <FONT COLOR="white" COLSPAN="1"><B>Project 01</B></FONT>
//                 </TD>
//             </TR>
//             <TR>
//                 <TD BGCOLOR="#f2f2f2" ALIGN="CENTER" COLSPAN="2">
...
//     >];
// }
    // Lab01 -> ProjectCard [style=dashed, weight=1, arrowsize=.5, weight=2.,color="#339966"]; // Align the cards
    // Lab02 -> ProjectCard [weight=1,arrowsize=.5, weight=2.,color="#003366"]; // Align the cards
    // Lab01 -> AssignmentCard [weight=1,arrowsize=.5, weight=2.,color="#339966"]; // Align the cards
    // Lab02 -> AssignmentCard [weight=1,arrowsize=.5, weight=2.,color="#339966"]; // Align the cards

    // AssignmentCard -> ProjectCard [style=dashed, weight=1, arrowsize=.5, weight=2.,color=skyblue]; // Align the cards

    // AWS01 -> ProjectCard [style=dashed, weight=1, arrowsize=.5, weight=2.,color=orange]; // Align the cards
    // AssignmentCard -> ProjectCard [ltail=clusterB,lhead=clusterC];
    // clusterB -> clusterC [style=invis]; // Align the cards
}
...
### 6.3 Self-Attention and Contextual Understanding
