...
format:
  revealjs:
    ...
    transition: fade
    auto-stretch: false
    footer: "AD 698 - From Linear Models to Multilayer Perceptrons"
...
:::: {.columns}
::: {.column width="60%"}
![A single neuron computing a weighted sum of inputs.](./M0_lecture03_figures/fig_linear_nn.png){width="100%"}
:::
::: {.column width="40%"}
