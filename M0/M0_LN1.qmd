...
![Colab Pro Sign Up](./M0_lecture02_figures/colab-signup.jpeg){width=80% fig-align="center" fig-alt="Colab Pro Sign Up"}
...
![](./M0_lecture02_figures/newnotebook1.png){width=80% fig-align="center" fig-alt="Image description"}

![](./M0_lecture02_figures/newnotebook2.png){width=80% fig-align="center" fig-alt="Image description"}
...
![](./M0_lecture02_figures/changeruntime1.png){width=80% fig-align="center" fig-alt="Image description"}

![](./M0_lecture02_figures/changeruntime2.png){width=80% fig-align="center" fig-alt="Image description"}
...
![](./M0_lecture02_figures/runnotebook1.png){width=20% fig-align="center" fig-alt="Image description"}
...
![](./M0_lecture02_figures/runnotebook2.png){width=80% fig-align="center" fig-alt="Image description"}
...
![](./M0_lecture02_figures/runnotebook3.png){width=80% fig-align="center" fig-alt="Image description"}
...
![colab push](./M0_lecture02_figures/colab_push.png){width="60%" fig-align="center" fig-alt="colab push"}
...
![](./M0_lecture02_figures/github-colab-step1.png){width=100% fig-alt="Image description"}
...
![](./M0_lecture02_figures/github-colab-step2.png){width=100% fig-alt="Image description"}
...
![](./M0_lecture02_figures/github-colab-step3.png){width=100% fig-alt="Image description"}
...
![](./M0_lecture02_figures/github-colab-step4.png){width=100% fig-alt="Image description"}

For **Repository permissions**, change the access to the **Contents** to **Read and Write**.

![](./M0_lecture02_figures/github-colab-step5.png){width=100% fig-alt="Image description"}

Now scroll down and click on **Generate token**. This will show you the list of tokens and you will be able to copy this one.

![](./M0_lecture02_figures/github-colab-step6.png){width=100% fig-alt="Image description"}
...
![](./M0_lecture02_figures/github-colab-step7.png){width=80% fig-alt="Image description"}
