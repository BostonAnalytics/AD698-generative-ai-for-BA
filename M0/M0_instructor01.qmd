...
subtitle: "M0 instructor01"
format:
  revealjs: 
    toc: false
    transition: fade
    theme: [../theme/instructor.scss]  # Custom styles for sidebar and layout
categories: ['Deep Learning Foundations', 'PyTorch', 'Neural Networks', 'Tensors']
description: "Supports instruction around deep learning setup, tensor workflows, and early neural-network learning goals."
---
