...
format:
  html:
    ...
    toc-depth: 3
    code-overflow: wrap
categories: ['M0:', 'Linear Models', 'MLP', 'Deep Learning', 'Lecture Notes']
description: "Lecture notes for Module 0 covering From Linear Models to Multilayer Perceptrons."
---
