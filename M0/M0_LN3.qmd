---
title: "Module 0, Lecture 3: Neural Networks — Regression and Classification"
...
description: "A comprehensive, chapter-style treatment of neural network fundamentals: linear regression, softmax classification, multilayer perceptrons, and the PyTorch builders guide — from first principles to production-ready deep learning code."
format:
  html:
    toc: true
    toc-depth: 3
