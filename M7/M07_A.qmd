...
When possible, preserve the original interaction using a share link or export feature. Examples include Gemini export to Google Docs, ChatGPT shared links, Claude shared chat links, and Perplexity shared thread links.
