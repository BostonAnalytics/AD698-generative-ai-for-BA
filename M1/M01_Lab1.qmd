...
format:
  html:
    code-overflow: wrap
categories: ['NLP Foundations', 'SEC Text', 'Language Probability', 'Text Representation', 'Applied Practice', 'Validation']
description: "Gives students applied practice with SEC 10-K NLP Preprocessing Pipeline, requiring intermediate checks, diagnostic outputs, failure analysis, and interpretation of results."
execute:
  echo: true
  eval: false
---
