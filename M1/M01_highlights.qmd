...
format:
    html:
        code-fold: true
date-format: long
categories: ['NLP Foundations', 'SEC Text', 'Language Probability', 'Text Representation', 'Learning Objectives', 'Module Roadmap']
description: "Previews the learning arc for Language Probability and Representation, emphasizing the concepts, tools, and applied skills students should track throughout the module."
---
