...
execute:
  echo: true
  eval: false
categories: ['NLP Foundations', 'SEC Text', 'Language Probability', 'Text Representation', 'Applied Assessment', 'Business Analytics']
description: "Assesses students' ability to apply Vocabulary, Frequency, and a First Classifier from SEC 10-K Filings through reproducible analysis, evidence-based reasoning, validation, and business interpretation."
---
...
:::{.callout-note}
This assignment is intentionally more hands-off than the labs. Use `M01_T1`, `M01_T2`, `M01_Lab1`, and `M01_Lab2` as preparation, but do not treat them as a copy-and-paste template for the final submission.
:::
