...
- This assignment must be completed using **Google Colab with a GPU runtime** (Runtime â†’ Change runtime type â†’ T4 GPU).
...
1. **Word Report (`.docx`)** — maximum 10 pages, APA 7 formatted
   ...
   - Encoder vs. Decoder conceptual comparison (â‰¤1 page)
...
**Encoder vs. Decoder — conceptual framing (required in Word document, â‰¤1 page):**
...
ðŸ“Š **Required:** Bar chart of chunk counts per company and per item type.
...
ðŸ“Š **Required:** All four heatmaps with token labels on both axes.
...
ðŸ“Š **Required:** Confusion matrix heatmap with company names on axes.
...
ðŸ“Š **Required:** Box plot of perplexity by company, with a second panel by item type (Item 7 vs Item 7A vs Item 8).
...
ðŸ“Š **Required:** Show this table in your Word document. You will use beta and return in Q3 and Q4.
...
ðŸ“Š **Required:** Horizontal bar chart of all five methods sorted by accuracy.
...
**Answer in your Word document (â‰¤1 page):** Which of the five methods in your comparison table would you recommend? Your answer must explicitly reference:
