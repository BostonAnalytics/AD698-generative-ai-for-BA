...
execute:
    ...
    warning: false
    message: false
categories: ['Transformers', 'Attention', 'Context Windows', 'Conceptual Foundations', 'Context']
description: "Explains Transformers, Attention, and Context with the technical concepts, mathematical intuition, implementation patterns, and evaluation mindset needed for applied GenAI analytics."
---
