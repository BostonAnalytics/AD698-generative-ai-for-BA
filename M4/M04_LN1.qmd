...
categories: ['Lecture', 'Notes', 'M04:', 'Transformers', 'Attention']
description: "Attention mechanisms, multi-head self-attention, positional encoding, and the transformer architecture."
execute:
    echo: true
    eval: false
    warning: false
