...
subtitle: "1.neural-network-regression"
...
date-format: long
engine: jupyter
categories: ['M08:', 'Module']
description: "Module 8 content focused on 1.neural-network-regression."
---
...
![Linear regression is a single-layer neural network.](./images/singleneuron.svg){#fig-single_neuron width=80%, fig-align="center" fig-alt="A diagram of a single neuron with multiple inputs and one output."}
...
![The real neuron (source: "Anatomy and Physiology" by the US National Cancer Institute's Surveillance, Epidemiology and End Results (SEER) Program).](./images/neuron.svg){#fig-Neuron width=80%, fig-align="center" fig-alt="A diagram of a biological neuron with dendrites, nucleus, axon, and axon terminals."}
