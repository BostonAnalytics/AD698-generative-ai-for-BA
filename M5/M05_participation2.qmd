...
categories: ['Research Communication', 'RAG', 'Evaluation', 'GenAI Literature', 'Research Literacy']
description: "Builds research literacy through scholarly communication that connects RAG, Retrieval, Evaluation to assumptions, limitations, systems thinking, and responsible AI implications."
---
...
* Develop the ability to **read and interpret AI resear---
title: "AD698 - Applied Generative AI"
subtitle: "Group/Week Paper Presentation"
number-sections: true
date: "2024-11-21"
...
bibliography: ../references.bib
csl: ../mis-quarterly.csl
categories: ['Research Communication', 'RAG', 'Evaluation', 'GenAI Literature']
description: "Builds research literacy through scholarly communication that connects RAG, Retrieval, Evaluation to assumptions, limitations, systems thinking, and responsible AI implications."
---
...
- [You can also search these papers on [scholar.google.com](https://scholar.google.com) and on [BU Library](https://www.bu.edu/library/) to find the full text. In most cases the full text is available for free.]{.uured-bold}
...
* Predicting Risk from Financial Reports with Regression [@kogan-etal-2009-predicting]
* When is a liability not a liability? [@Loughran2011liability]
...
![ChatGPT shared conversation link interface](../M0/M0_lecture01_figures/chatgpt-share.jpg){width="80%" fig-align="center" fig-alt="ChatGPT shared conversation link interface" #fig-participation2-chatgpt-share-1}
...
![ChatGPT shared conversation link interface](../M0/M0_lecture01_figures/chatgpt-share.jpg){width="80%" fig-align="center" fig-alt="ChatGPT shared conversation link interface" #fig-participation2-chatgpt-share-2}

![Gemini shared conversation link interface](../M0/M0_lecture01_figures/gemini-share-conversation.png){width="80%" fig-align="center" fig-alt="Gemini shared conversation link interface" #fig-participation2-gemini-share-2}
...
![Gemini shared conversation link interface](../M0/M0_lecture01_figures/gemini-share-conversation.png){width="80%" fig-align="center" fig-alt="Gemini shared conversation link interface" #fig-participation2-gemini-share-3}
...
![ChatGPT shared conversation link interface](../M0/M0_lecture01_figures/chatgpt-share.jpg){width="80%" fig-align="center" fig-alt="ChatGPT shared conversation link interface" #fig-participation2-chatgpt-share-4}

![Gemini shared conversation link interface](../M0/M0_lecture01_figures/gemini-share-conversation.png){width="80%" fig-align="center" fig-alt="Gemini shared conversation link interface" #fig-participation2-gemini-share-4}
