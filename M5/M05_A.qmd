...
execute:
  echo: true
  eval: false
categories: ['M05:', 'Assignment', 'RAG', 'SEC 10-K', 'Evaluation', 'Auditability']
description: "Assignment for Module 5 requiring students to compare prompt-only, RAG, and pretraining-based SEC 10-K analysis with retrieval diagnostics, grounding evidence, and business interpretation."
---
