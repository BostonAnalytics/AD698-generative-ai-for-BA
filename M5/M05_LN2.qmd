...
The notebooks in `help-code/4-nlp-finance` are useful bridge material for this module because they connect NLP mechanics to financial filings. The Apple 2025 Form 10-K companion files make the examples concrete before students move to their own rival-company corpus.
