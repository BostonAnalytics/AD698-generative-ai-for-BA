...
:::: {.columns}
::: {.column width="52%"}
![](./M03_lecture01_figures/encoder_decoder.svg){width=100% fig-align=center fig-alt="Encoder-decoder architecture transforming an input sequence into an output sequence" #fig-encoder-decoder}
:::
