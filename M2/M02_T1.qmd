...
execute:
    ...
    warning: false
    message: false
categories: ['SEC HTML', 'Corpus Construction', 'Language Modeling', 'Text Representation', 'Guided Implementation']
description: "Guides students through a hands-on implementation of From SEC HTML to a Reusable Section Corpus, with reusable code patterns, validation checks, and artifacts for later labs and assignments."
---
