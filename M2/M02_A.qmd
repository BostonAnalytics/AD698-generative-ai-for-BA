...
execute:
  echo: true
  eval: false
categories: ['Language Modeling', 'Text Representation', 'Semantic Similarity', 'SEC Corpus', 'Applied Assessment', 'Business Analytics']
description: "Assesses students' ability to apply Word Embeddings and the Geometry of Rivalry in SEC 10-K Filings through reproducible analysis, evidence-based reasoning, validation, and business interpretation."
---
...
:::{.callout-note}
## How This Assignment Connects

- `M02_T1` and `M02_Lab1` focus on building and validating reusable SEC text artifacts.
- `M02_T2` and `M02_Lab2` focus on semantic representations, retrieval, and probability-based evaluation.
- This assignment builds on those ideas, but students must still use their own rival-company corpus from Assignment 1 and produce original executed results.
:::
...
ðŸ“Š **Required:** Stacked bar chart of chunk counts by company and by item type (Item 7 vs Item 7A vs Item 8).
...
ðŸ“Š **Required:** For two of the five terms, show a horizontal bar chart of the top-10 nearest neighbors sorted by similarity. Label axes and include the term in the chart title.
...
ðŸ“Š **Required:** Training loss curve with Word2Vec model and GloVe model on the same chart.
...
ðŸ“Š **Required:** Horizontal bar chart of all three method accuracies.
...
ðŸ“Š **Required Plot 1:** 2D scatter plot colored by company. Title: "Embedding Space by Company." Do the two rivals form separate clusters or overlap?

ðŸ“Š **Required Plot 2:** 2D scatter plot colored by item type (Item 7 vs Item 7A vs Item 8). Title: "Embedding Space by 10-K Section." Which section separates more cleanly?
...
ðŸ“Š **Required Plot 3:** 2D scatter plot colored by `return_quintile`. Title: "Embedding Space by Return Quintile." Do high-return-year filings cluster differently from low-return-year filings?
...
ðŸ“Š **Required:** Include the accuracy bar chart from Section 5 in your Word document.
