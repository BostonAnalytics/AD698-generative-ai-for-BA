...
format:
  revealjs:
    ...
    transition: fade
    auto-stretch: false
    footer: "AD 698 - From Words to Structured Text"
...
categories: ['Language Modeling', 'Text Representation', 'Semantic Similarity', 'SEC Corpus', 'Technical Deep Dive']
description: "Introduces From Words to Structured Text through presentation-ready concepts, technical intuition, diagrams, and applied connections to the course analytics workflow."
---
...
::: {.column width="47%"}
![](./M02_lecture02_figures/naive-bayes-wordvec.png){width="100%" fig-alt="Simple illustration connecting bag-of-words classification to learned word vectors."}
:::
::::
...
## Static embeddings {.paired-diagrams}
...
:::: {.columns}
::: {.column width="50%"}
![](./M02_lecture02_figures/cbow.svg){width="100%" fig-alt="CBOW architecture diagram."}
:::
::: {.column width="50%"}
![](./M02_lecture02_figures/skip_gram.svg){width="100%" fig-alt="Skip-gram architecture diagram."}
:::
::::
...
## Distance Metrics in Embedding Space {.figure-only}
...
::: {.column width="47%"}
![Mahalanobis Distance](./M02_lecture02_figures/mahalanobis-outlier.jpg){width="100%" fig-alt="Mahalanobis distance illustration." fig-align="center" #fig-mahalanobis}
:::
::::
...
::: {.column width="47%"}
![Entropy curve for a coin toss](./M02_lecture02_figures/entropy-coin-curve.png){width="100%" fig-alt="Entropy curve for a coin toss showing maximum uncertainty at p equals 0.5." fig-align="center" #fig-entropy-coin}
:::
::::
...
::: {.column width="47%"}
![ReLU squiggle](./M02_lecture02_figures/relu-squiggle.png){width="100%" fig-alt="A few ReLU units combining into a flexible squiggle-like response curve." fig-align="center" #fig-relu-squiggle}
:::
::::
...
::: {.column width="47%"}
![Multilayer perceptron diagram](./M02_lecture02_figures/Multilayer-perceptron.png){width="100%" fig-alt="Multilayer perceptron diagram." fig-align="center" #fig-multilayer-perceptron}
:::
::::
...
::: {.column width="47%"}
![Gradient descent steps](./M02_lecture02_figures/gradient-descent-steps.png){width="100%" fig-alt="Gradient descent takes larger steps early and smaller steps near the minimum." fig-align="center" #fig-gradient-descent}
:::
::::
...
## Minimal PyTorch pattern: text features
...
## Minimal PyTorch pattern: model and learning
...
::: {.column width="47%"}
![](./M02_lecture02_figures/rnn.svg){width="100%" fig-alt="Recurrent neural network diagram."}
:::
::::
...
## LSTM and GRU improve memory {.paired-diagrams}
...
:::: {.columns}
::: {.column width="50%"}
![](./M02_lecture02_figures/lstm.svg){width="100%" fig-alt="LSTM diagram."}
:::
::: {.column width="50%"}
![](./M02_lecture02_figures/gru.svg){width="100%" fig-alt="GRU diagram."}
:::
::::
