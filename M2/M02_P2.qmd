...
![Contingency Table](./M02_lecture02_figures/complete-contingecy-matrix.png){width=60% fig-align=center #fig-confusion-matrix fig-alt="Illustration of a confusion matrix showing true positives, false positives, true negatives, and false negatives."}
...
- Download data for analysis from [here](https://drive.google.com/drive/folders/1djzbe1pWmHpGwHIHPiN_PQYnBIWQJ6vd?usp=sharing)
...
- All information must pass through $h_t$.
