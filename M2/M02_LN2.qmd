...
## Naïve Bayes in Practice: Sklearn on SEC 10-K Text
...
### From NB to MLP: Same Task, Neural Approach
...
for epoch in range(10):
    ...
    if (epoch + 1) % 5 == 0:
        ...
        print(f"Epoch {epoch+1:>3} | loss={total_loss/len(train_dl):.4f} | val_acc={acc:.3f}")
```
...
## What's Next: Sequence Models and Attention

The bag-of-words and embedding representations developed here treat tokens *independently* or in shallow contexts.
Real language is sequential: meaning depends on order, and long-range dependencies matter.
