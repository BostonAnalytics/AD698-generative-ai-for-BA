...
- **Section {{< var first_section >}}**
  - The first day of the week (Day 1) for section **{{< var first_section >}}** is {{< first_day >}}{.uugreen-bold}, this is the day we will conduct our live classroom sessions.
  - The last day of the week (Day 7) for section **{{< var first_section >}}** is {{< last_day_first_section >}}{.uured-bold}.

- **Section {{< var second_section >}}**
  - The first day of the week (Day 1) for section **{{< var second_section >}}** is {{< second_day >}}{.uugreen-bold}, this is the day we will conduct our live classroom sessions.
  - The last day of the week (Day 7) for section **{{< var second_section >}}** is {{< last_day_second_section >}}{.uured-bold}.
