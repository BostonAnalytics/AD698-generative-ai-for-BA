...
- **Section `{{ first_section }}`**
  - The first day of the week (Day 1) for section `{{ first_section }}` is [`{{ first_day }}`]{.uugreen-bold}, this is the day we will conduct our live classroom sessions.
  - The last day of the week (Day 7) for section `{{ first_section }}` is [`{{ last_day_first_section }}`]{.uured-bold}.

- **Section `{{ second_section }}`**
  - The first day of the week (Day 1) for section `{{ second_section }}` is [`{{ second_day }}`]{.uugreen-bold}, this is the day we will conduct our live classroom sessions.
  - The last day of the week (Day 7) for section `{{ second_section }}` is [`{{ last_day_second_section }}`]{.uured-bold}.
