...
There is **one required textbook** for this course. All core readings, technical documentation, and video tutorials will be provided on the course site.
...
Generative AI tools are **allowed and expected** in this course. However, all students must:

* Document AI usage
* Validate outputs
* Take responsibility for final submissions

Failure to appropriately disclose or validate AI-assisted work may result in penalties.
