...
sections.drop(0, inplace=True)  # Drop the first row which contains the section names
...
:::{.callout-important}
[Online Students]{.uured-bold}: Please Submit a one page pdf/word with answers to the following questions by the end of the week. Please include the name of the paper and the authors in your submission.
