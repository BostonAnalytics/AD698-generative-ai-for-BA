...
```{python}
%pip install -q beautifulsoup4 requests pandas numpy matplotlib seaborn faiss-cpu sentence-transformers langchain langchain-community langchain-text-splitters langchain-huggingface langchain-openai ragas datasets
```
